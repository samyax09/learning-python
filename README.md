# Learning Python
    ...
    A collection of my Python learning exercises.

    ## Exercises

    1. [Basic Calculator — First Exercise](https://github.com/samyax09/basic-calculator-first-exercise)
    2. [String Commands](https://github.com/samyax09/string-commands)
